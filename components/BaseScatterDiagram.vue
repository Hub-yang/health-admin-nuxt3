    ...
    <div class="w-full flex flex-1">
      ...
      >
        <transition>
          ...
          <span
            v-else
            class="i-solar-double-alt-arrow-right-linear block h-full cursor-pointer text-xl transition-all-300 hover:text-2xl"
          />
        </transition>
      </div>
      <div
      ...
      >
        <transition>
          ...
          <span
            v-else
            class="i-solar-double-alt-arrow-left-linear block h-full cursor-pointer text-xl transition-all-300 hover:text-2xl"
          />
        </transition>
      </div>
    </div>
